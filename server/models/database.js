...
client.connect();
var query = client.query('CREATE TABLE users(userID int PRIMARY KEY, saltMaster varchar(255) not null, privKeyEnc varchar(2048) not null, pubKey VARCHAR(2048) not null);' +
